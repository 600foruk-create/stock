<div class="rm-dashboard">
    <h2 style="color: var(--sky-600); margin-bottom: 2rem; display: flex; align-items: center; gap: 0.8rem;">
        <span style="font-size: 2rem;">🏗️</span> Raw Materials Dashboard
    </h2>
    ...
    <div class="dashboard-grid" style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 1.5rem; margin-bottom: 2rem;">
        ...
        <div class="stat-card" style="background: white; padding: 1.5rem; border-radius: 1.2rem; border-left: 5px solid var(--orange-500); box-shadow: var(--shadow-sm);">
            <div class="stat-label" style="color: var(--gray-500); font-weight: 600; font-size: 0.9rem; text-transform: uppercase; letter-spacing: 0.5px;">Stock Valuation</div>
            <div class="stat-value" id="rmStockValuation" style="font-size: 2.2rem; font-weight: 800; color: var(--gray-800); margin-top: 0.5rem;">0</div>
        </div>
    </div>
