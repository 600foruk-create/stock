    ...
    <div style="background: white; border-radius: 12px; border: 1px solid var(--gray-200); box-shadow: var(--shadow-sm); overflow: hidden;">
        ...
        <div style="overflow-x: auto; max-height: 700px; overflow-y: auto; position: relative;">
            <table class="data-table" style="margin-bottom: 0; min-width: 1300px; border-collapse: separate; border-spacing: 0;">
                <thead style="position: sticky; top: 0; z-index: 20; background: var(--sky-500); color: white; box-shadow: 0 1px 2px rgba(0,0,0,0.1);">
                    <tr>
                        <th style="padding: 1rem 0.8rem; border-bottom: 2px solid var(--sky-600);">Date & Time</th>
                        <th style="padding: 1rem 0.8rem; text-align: left; border-bottom: 2px solid var(--sky-600);">FG Produced (KG)</th>
                        <th style="padding: 1rem 0.8rem; text-align: left; border-bottom: 2px solid var(--sky-600);">RM Issued (KG)</th>
                        <th style="padding: 1rem 0.8rem; text-align: left; border-bottom: 2px solid var(--sky-600);">Issuance Value (Rs.)</th>
                        <th style="padding: 1rem 0.8rem; text-align: left; border-bottom: 2px solid var(--sky-600);">Other Expenses (Rs.)</th>
                        <th style="padding: 1rem 0.8rem; text-align: left; border-bottom: 2px solid var(--sky-600);">Grand Total (Rs.)</th>
                        <th style="padding: 1rem 0.8rem; text-align: left; border-bottom: 2px solid var(--sky-600);">In Process (KG)</th>
                        <th style="padding: 1rem 0.8rem; text-align: left; border-bottom: 2px solid var(--sky-600);">Gap / WIP (Net)</th>
                        <th style="padding: 1rem 0.8rem; text-align: center; border-bottom: 2px solid var(--sky-600);">Actions</th>
                    </tr>
                </thead>
                <tbody id="rmConsumptionHistoryTable" class="striped-rows">
                    <!-- Data will be injected here -->
                </tbody>
                <tfoot id="rmConsumptionHistoryFooter" style="background: var(--sky-500); color: white; font-weight: bold; position: sticky; bottom: 0; z-index: 10; box-shadow: 0 -1px 2px rgba(0,0,0,0.2);">
...
.striped-rows tr:nth-child(odd) {
    background-color: #fafff7; /* Even Lighter Green */
}
.striped-rows tr:nth-child(even) {
    background-color: #fffff2; /* Even Lighter Yellow */
}
