    ...
    if ($method === 'GET') {
        if ($action === 'get_all') {
            ...
            $data = [
                ...
                'storeLatestAudit' => $conn->query("SELECT item_id, godown_qty FROM audit_records ar1 WHERE report_type = 'STORE' AND id = (SELECT MAX(id) FROM audit_records ar2 WHERE ar2.item_id = ar1.item_id AND ar2.report_type = 'STORE')")->fetchAll(PDO::FETCH_ASSOC),
